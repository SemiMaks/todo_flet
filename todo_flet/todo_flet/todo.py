                ...
                ft.Row(
                    ...
                    controls=[
                        ft.IconButton(
                            ...
                            tooltip="Редактирование ToDo",
                            on_click=self.edit_clicked,
                        ),
                        ft.IconButton(
                            ft.icons.DELETE_OUTLINE,
                            tooltip="Удалить ToDo",
...
class TodoApp(ft.UserControl):
    def build(self):
        ...
        self.items_left = ft.Text("0 дел осталось")

        return ft.Column(
            width=600,
            controls=[
                ft.Row(
                    [ft.Text(value="Список дел", style=ft.TextThemeStyle.HEADLINE_MEDIUM)],
    ...
    async def update_async(self):
        ...
        for task in self.tasks.controls:
            ...
            if not task.completed:
                count += 1
        self.items_left.value = f"осталось {count} активное(х) дел(о)"
        await super().update_async()


async def main(page: ft.Page):
    page.title = "Список дел App"
